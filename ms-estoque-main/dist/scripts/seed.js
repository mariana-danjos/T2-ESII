...
async function main() {
    for (const s of suppliers) {
        await pool_1.pool.query(`INSERT INTO suppliers (legal_name, trade_name, document, document_type, email, phone, contact_person, address_city, address_state, address_country)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9,'Brasil')
       ON CONFLICT (document) DO NOTHING`, [s.legal, s.trade, s.doc, s.type, s.email, s.phone, s.contact, s.city, s.state]);
    }
